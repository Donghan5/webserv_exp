#!/usr/bin/env python3
"""
WebServer Diagnostic Tool - A comprehensive tester for HTTP servers with CGI support
"""
...
class WebServerTester:
    def __init__(self, args):
        ...
        self.tests = args.tests.split(',') if args.tests != 'all' else ['basic', 'static', 'cgi', 'methods', 'concurrent', 'stress']
        ...
        self.cgi_paths = [
            ...
            "/cgi-bin/info.py",
            "/cgi-bin/env.py",
            "/cgi-bin/slow.py",  # Should take a few seconds to respond
        ]
    ...
    def http_methods_test(self):
        ...
        try:
            ...
            failure += 1
            self.log(f"HEAD: Error - {str(e)}", level='error', test_name=test_name)
            details.append({
                'method': 'HEAD',
                'url': static_url,
                'error': str(e),
        ...
        # Test OPTIONS (to check CORS support)
        try:
            ...
            failure += 1
            self.log(f"OPTIONS: Error - {str(e)}", level='error', test_name=test_name)
            details.append({
                'method': 'OPTIONS',
                'url': root_url,
                'error': str(e),
        ...
        result = {
            ...
            'success': success,
            'failure': failure,
            'total': 4,  # Number of methods tested
            'details': details
        }
        self.results['summary'][test_name] = result
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <ul>
                ...
                <li><a href="/cgi-bin/info.py">Server Information</a></li>
            </ul>
        </div>
...
def main():
    parser = argparse.ArgumentParser(description="WebServer Diagnostic Tool")
    ...
    # Test configuration
    parser.add_argument("--tests", default="all", help="Comma-separated list of tests to run (basic,static,cgi,methods,concurrent,stress)")
